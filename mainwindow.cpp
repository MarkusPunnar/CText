...
void MainWindow::initMenus() {
    ...
    m_underlineFontAction= new QAction(this);
    m_underlineFontAction->setIcon(QIcon(":/images/underline.png"));
    m_underlineFontAction->setText(QString("Underline"));
    m_underlineFontAction->setShortcut(QKeySequence(tr("Ctrl+u")));
    m_stylingMenu->addAction(m_underlineFontAction);
    connect(m_underlineFontAction, &QAction::triggered,
            this, &MainWindow::changeFontToUnderline);
    ...
    m_fontAction = new QAction(this);
    m_fontAction->setText("&Font");
    menuBar()->addAction(m_fontAction);
    connect(m_fontAction, &QAction::triggered, this, &MainWindow::changeFont);
...
void MainWindow::changeFontToUnderline() {
    Tab* currentTab = openTabs.at(m_tab->currentIndex());
    currentTab->setFontUnderline(!currentTab->fontUnderline());
}
